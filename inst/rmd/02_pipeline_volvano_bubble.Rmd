...
data.impute <- 
  impute_various_methods( data,
                          ...
                          k = 5,
                          missing_thres = 0.2,
                          group.info = sample.info.pos$Group
  )
...
data.mean <-
  data.summary$type.mean

data.rsd <-
  data.summary$type.rsd

features.pos <-
  features %>%
  left_join(data.rsd, by = "Identity") %>%
  left_join(data.mean, by = "Identity")
...
data.impute <- 
  impute_various_methods( data,
                          ...
                          k = 5,
                          missing_thres = 0.2,
                          group.info = sample.info.neg$Group
  )
data.impute2 <- 
  impute_various_methods( data,
                          method = "LoD"
